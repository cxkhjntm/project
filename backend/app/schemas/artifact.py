...
class ArtifactBase(BaseModel):
    ...
    summary: str | None = Field(None, description="Brief summary of artifact content")
...
class SynthesizeRequest(BaseModel):
    ...
    title: str | None = Field(None, description="Override artifact title")
    include_citations: bool = Field(True, description="Include source citations in output")
    max_length: int | None = Field(None, ge=100, description="Max output length in characters")
