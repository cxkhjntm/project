...
class Citation(BaseModel):
    ...
    file: str | None = Field(None, description="File name")
    snippet: str | None = Field(None, description="Relevant snippet")
...
class MessageCreate(BaseModel):
    ...
    sender_id: str | None = Field(None, description="Role card ID for experts")
    content: str = Field(..., min_length=1, description="Message content")
    citations: list[Citation] | None = Field(None, description="Citations")
